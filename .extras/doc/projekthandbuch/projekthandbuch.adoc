...
."PkwGetController" für Lesezugriffe an der REST-Schnittstelle
[plantuml,PkwGetController,svg]
----
include::PkwGetController.plantuml[]
----
...
."PkwWriteController" für Schreibzugriffe an der REST-Schnittstelle
[plantuml,PkwGetController,svg]
----
include::PkwWriteController.plantuml[]
----
...
.PkwQueryResolver für Lesezugriffe an der GraphQL-Schnittstelle
[plantuml,PkwQueryResolver,svg]
----
include::PkwQueryResolver.plantuml[]
----

Donec sollicitudin molestie malesuada. Praesent sapien massa, convallis a
pellentesque nec, egestas non nisi.

.PkwMutationResolver für Schreibzugriffe an der GraphQL-Schnittstelle
[plantuml,PkwMutationResolver,svg]
----
include::PkwMutationResolver.plantuml[]
----
...
."PkwReadService" von der Geschäftslogik
[plantuml,PkwReadService,svg]
----
include::PkwReadService.plantuml[]
----

Pellentesque in ipsum id orci porta dapibus. Donec rutrum congue leo eget
malesuada.

."PkwWriteService" von der Geschäftslogik
[plantuml,PkwWriteService,svg]
----
include::PkwWriteService.plantuml[]
----
