...
--        chown postgres:postgres /var/lib/postgresql/tablespace/pkw
...
-- (5) 2. PowerShell:
--     docker compose exec db bash
--        psql --dbname=postgres --username=postgres --file=/sql/create-db-pkw.sql
--        psql --dbname=pkw --username=pkw --file=/sql/create-schema-pkw.sql
--        exit
--      docker compose down
...
CREATE ROLE pkw LOGIN PASSWORD 'p';

-- https://www.postgresql.org/docs/current/sql-createdatabase.html
CREATE DATABASE pkw;

GRANT ALL ON DATABASE pkw TO pkw;

-- https://www.postgresql.org/docs/10/sql-createtablespace.html
CREATE TABLESPACE pkwspace OWNER pkw LOCATION '/var/lib/postgresql/tablespace/pkw';
