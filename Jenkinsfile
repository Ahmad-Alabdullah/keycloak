    ...
    stages {
        ...
        stage('Init') {
            ...
            steps {
                ...
                git credentialsId: "1", url: 'https://github.com/bael1018/SWE-WS23-A1', branch: 'main', poll: true
            }
        }
        ...
        stage('Install') {
            steps {
                ...
                // /var/jenkins_home/workspace/pkw (siehe "pwd" oben)
                sh 'cat package.json'
        ...
        stage('Docker Image bauen') {
            steps {
                ...
                // sh 'docker buildx build --tag juergenzimmermann/pkw:2023.10.0 .'
            }
        }
